            ...
            Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        ...
                        "kb_type": {"type": "string", "enum": ["all", "delphi", "project", "thirdparty", "help", "document"], "default": "all", "description": "知识库范围: all=所有知识库, delphi=Delphi官方源码, project=项目源码, thirdparty=三方库源码, help=CHM帮助文档, document=通用文档(txt/md/html/docx/doc/pdf/epub/网页)"},
