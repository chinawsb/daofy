...
| `check_environment` | 诊断编译环境，返回编译器列表 | `action`(check/detect), `search_path` |
...
| 工具名称 | 功能描述 | 主要参数 |
|----------|----------|----------|
| `search_knowledge` | 搜索代码/类/函数/文档，构建/查看知识库 | `action`(search/stats/build), `query`, `kb_type`(all/delphi/project/thirdparty/help), `project_path`, `search_type`, `top_k`, `async_mode`, `force_rebuild` |

### 源码读取工具

| 工具名称 | 功能描述 | 主要参数 |
|----------|----------|----------|
| `read_source_file` | 读取指定文件内容或搜索类/函数位置 | `file_path`, `search_type`(path/class/function), `type_name`, `function_name`, `search_in`, `start_line`, `max_lines` |
...
| 工具名称                | 功能描述                              | 必需参数              |
| ------------------- | --------------------------------- | ----------------- |
| `compile_project`  | 编译 Delphi 工程或检查 .pas 文件语法       | `project_path`, `get_args_only`(可选)    |
| `check_environment` | 诊断编译环境问题                       | `action`(check/detect) |

### 知识库工具

| 工具名称             | 功能描述                        | 必需参数         |
| ------------------ | ----------------------------- | ------------ |
| `search_knowledge` | 搜索代码/类/函数/文档，构建/查看知识库 | `action`(search/stats/build), `query` |

### 源码读取工具

| 工具名称                 | 功能描述                        | 必需参数        |
| ---------------------- | ----------------------------- | ----------- |
| `read_source_file`    | 读取指定文件或搜索类/函数位置 | `file_path`, `search_type`(path/class/function) |

### 代码格式化工具

| 工具名称                    | 功能描述              | 必需参数        |
| ----------------------- | ----------------- | ----------- |
| `format_delphi`    | 格式化源码/代码，检查/设置 pasfmt | `action`(file/code/check/set_path/status) |

### 异步任务工具

| 工具名称           | 功能描述              | 必需参数      |
| -------------- | ----------------- | --------- |
| `async_task` | 管理后台任务          | `action`(start/status/result/list/cancel) |
